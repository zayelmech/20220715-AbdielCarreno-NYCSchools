...
import com.imecatro.nyc_schools.network.SchoolService
import com.imecatro.nyc_schools.network.SchoolService.Companion.BASE_URL
...
class NetworkModule {
    ...
    @Provides
    fun providesJokesService(retrofit: Retrofit): SchoolService =
